...
export const PACKAGES = [
  ...
  {
    id: "inv",
    name: "Инвертор Комфорт",
    tag: "до 35 м²",
    forText: "Зал, большая гостиная",
    power: "3.5 кВт · инвертор",
    price: 49900,
    old: 61900,
    badge: "Тихий",
    includes: ["Инверторный кондиционер", "Монтаж до 3 м трассы", "Тихий режим для сна", "Экономия до 40% энергии", "Гарантия 3 года"]
  }
];
...
export const REVIEWS = [
  ...
  { name: "Дмитрий, Купчино", text: "Долго выбирал, везде разные цены. Тут сразу сказали итог под ключ. В спальне вообще не слышно, как работает.", rate: 5, tag: "Инвертор" },
...
export const FAQS = [
  { q: "Сколько стоит кондиционер с установкой под ключ?", a: "Готовые пакеты — от 29 900 ₽ за всё: техника, монтаж до 3 м трассы, расходники и пусконаладка. Точную цену называем на бесплатном замере и фиксируем — на месте доплат не будет." },
  ...
  { q: "Будет ли шумно в спальне?", a: "Подбираем тихие и инверторные модели и устанавливаем внутренний блок так, чтобы не было гула и вибраций. В пакете «Инвертор» — специальный ночной режим." },
...
> = {
  v1: {
    ...
    h1: ["Кондиционер под ключ", "от 29 900 ₽"],
...
export function recommend(area: number): Recommendation {
  if (area <= 18) return { model: "Сплит «07» · 2.0 кВт", pkg: "Старт", price: 29900 };
  if (area <= 27) return { model: "Сплит «09» · 2.6 кВт", pkg: "Оптимум", price: 36900 };
  if (area <= 35) return { model: "Сплит «12» · 3.5 кВт", pkg: "Инвертор Комфорт", price: 49900 };
  if (area <= 50) return { model: "Сплит «18» · 5.0 кВт", pkg: "Инвертор Макси", price: 64900 };
